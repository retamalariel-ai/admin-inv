-- =============================================================================
-- FIX: market_value_ars y market_value_usd para FCIs denominados en USD
--
-- Bug: FCIs con currency = 'USD_MEP'/'USD_CCL'/'USD' (ej: COCOAUSD, COCOUSDPA)
-- compartían el mismo CASE que los FCIs en ARS, ignorando la moneda del activo.
--
-- Resultado incorrecto:
--   market_value_ars = qty × price_usd           ← falta × fx_mep
--   market_value_usd = qty × price_usd / fx_mep  ← divide cuando ya está en USD
--
-- Fix: agregar sub-CASE por a.currency dentro del bloque de tipos FCI/ACCION.
-- =============================================================================
